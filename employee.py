...
class Employee:
    ...
    def convertToDictAndUpload(self) -> None:
        ...
        utility.employeeDB.insert_one({'_id': id, 'Name': self.name, 'Phone': self.phone, 'Email': self.email, 'Address': self.address, 'Branch': self.branch, 'Date Of Joining': self.dateOfJoining})